...
/**
 * Created by danilosilva
 */
public class UniPHTemplateLoader implements TemplateLoader {

	private static final Object[] NOMES = { "Thaís Fernanda", "Gabriel Maciel", "Pedro Henrique", "Julianne Monteiro",
			"Paulo Lerbach", "Sued Ellen", "Eliseu Moraes", "Nawaly Akhras", "Pedro Felipe" };
		...
		Fixture.of(Professor.class).addTemplate(VALID, new Rule() {
			{
				...
				add("telefone", random(TELEFONES));
				add("email", MILLIS + "@gmail.com");
				add("dataCadastro", randomDate("2011-04-15", "2011-11-07", new SimpleDateFormat("yyyy-MM-dd")));
				add("curriculo", random(CVS));
			}
		});
